...
#region Movement
	if (!puzzle_finished) {
		...
		if (horizontal != 0 || vertical != 0) {
			var x_limits = (x + horizontal < obj_system.grid_cell_size * (obj_system.grid_cell_width + 1)) && (x + horizontal >= obj_system.grid_cell_size);
			var y_limits = (y + vertical < obj_system.grid_cell_size * (obj_system.grid_cell_height + 1)) && (y + vertical >= obj_system.grid_cell_size);
